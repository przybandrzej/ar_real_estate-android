...
public class LocationProvider {
  ...
  /**
   * location updates should fire approximately every half second
   */
    ...
    if(this.locationManager != null) {
      ...
      if(this.gpsProviderEnabled) {
        ...
        if(locationManager.getProvider(LocationManager.GPS_PROVIDER) != null) {
          this.locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, LOCATION_UPDATE_MIN_TIME, LOCATION_UPDATE_DISTANCE, this.locationListener);
        }
      }
      ...
      if(this.networkProviderEnabled) {
        ...
        if(locationManager.getProvider(LocationManager.NETWORK_PROVIDER) != null) {
          this.locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, LOCATION_UPDATE_MIN_TIME, LOCATION_UPDATE_DISTANCE, this.locationListener);
        }
      }
